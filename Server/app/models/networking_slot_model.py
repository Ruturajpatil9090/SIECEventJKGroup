...
class EveNetworkingSlot(Base):
    __tablename__ = "Eve_NetworkingSlot"

    NetworkingSlotId = Column(Integer, primary_key=True, autoincrement=True)
    ...
    NetworkingSlotSession_Bio = Column(String(255), nullable=True)
