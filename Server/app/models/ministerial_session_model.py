...
class EveMinisterialSession(Base):
    __tablename__ = "Eve_MinisterialSessions"

    MinisterialSessionId = Column(Integer, primary_key=True, autoincrement=True)
    ...
    MinisterialSession_Bio = Column(Text, nullable=True)
