...
import { useGetTeamMastersQuery } from '../services/teamMasterApi';
...
function TaskDescriptionCardView() {
    ...
    const { data: teamsData = [], isLoading: isTeamsLoading } = useGetTeamMastersQuery();
    ...
    const handleTeamSelect = (selectedOption) => {
        ...
        if (selectedOption && selectedOption.teamData.details) {
            ...
            const teamUsers = tbluser.filter(user => teamUserIds.includes(user.User_Id));
    ...
    const handleEdit = (task) => {
        ...
        setFormData({
            ...
            TeamMasterId: task.TeamMasterId || null,
        ...
        // Set the team selection if TeamMasterId exists
        if (task.TeamMasterId) {
            const teamOption = teamOptions.find(team => team.value === task.TeamMasterId);
            setSelectedTeam(teamOption || null);
        } else {
    ...
    const handleSubmit = async (e) => {
        ...
        const payloadData = {
            ...
            TeamMasterId: formData.TeamMasterId || null,
        };
    ...
    const isLoading = isTableLoading || isTblUserLoading || issystemMasterLoading || isMaxIdLoading || isTeamsLoading;
