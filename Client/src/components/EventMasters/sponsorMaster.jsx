...
function SponsorMaster() {
    ...
    const { data: maxSponsorId = 0, isLoading: isMaxIdLoading, refetch: refetchMaxId } = useGetMaxSponsorIdQuery();
    ...
    return (
        <>
            ...
            <Modal
                ...
                width="1200px"
            >
                <form onSubmit={handleSubmit} className="space-y-1" style={{marginBottom:"1800px"}}>
