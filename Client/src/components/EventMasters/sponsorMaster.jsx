    ...
    return (
        <>
            ...
            >
                <form onSubmit={handleSubmit} onKeyDown={(e) => {
                    ...
                    <div className="grid grid-cols-1 gap-1 sm:grid-cols-4">
                        ...
                        <div>
                            <label htmlFor="event_code" className="block text-sm font-medium text-gray-700 mb-1">Event Code  <span className="text-red-500">*</span></label>
                            <Select
                                id="event_code"
                        ...
                        <div>
                            <label htmlFor="category_code" className="block text-sm font-medium text-gray-700 mb-1">Category  <span className="text-red-500">*</span></label>
                            <Select
                                id="category_code"
            ...
            <SponsorDetailsPopup
                ...
                isLoading={isSponsorDetailsLoading}
            />
        </>
    );
}
